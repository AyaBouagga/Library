...
public class DescripBookforsearch extends JPanel {
	...
	public DescripBookforsearch(int id ,String BookName ,String  bookw,String imgbook,String path,int nb_pages,int nb_like) {
		setMinimumSize(new Dimension(700, 300));
		setPreferredSize(new Dimension(924, 220));
		setForeground(new Color(0, 0, 0));
		this.setBounds(0,0,859,197);
		this.identifiant=id;
		...
		btnimgbook.setBounds(0, 0, 221, 127);
	    ...
	    label_2.setBounds(42, 138, 123, 34);
	    panel.add(label_2);
	   ...
	   buttonLike.addActionListener(new ActionListener() {
	    ...
	    btnNewButton.setBounds(41, 126, 109, 23);
	    ...
	    button_1.setBounds(75, 25, 40, 47);
	    ...
	    button_2.setBounds(125, 25, 40, 47);
		...
		paneldescrip.setBounds(234, 3, 592, 180);
		
		
		JLabel label = new JLabel("Pages:");
		label.setForeground(new Color(153, 0, 0));
		label.setFont(new Font("Arabic Typesetting", Font.BOLD, 25));
		label.setBounds(10, 43, 100, 18);
		...
		label_1.setBounds(156, 41, 72, 20);
		paneldescrip.add(label_1);
		
		JLabel label_21 = new JLabel("Writer:");
		label_21.setForeground(new Color(153, 0, 0));
		label_21.setFont(new Font("Arabic Typesetting", Font.BOLD, 25));
		label_21.setBounds(10, 11, 100, 20);
		paneldescrip.add(label_21);
		
		JLabel label_3 = new JLabel(bookWriter);
		label_3.setForeground(new Color(153, 0, 0));
		label_3.setFont(new Font("Arabic Typesetting", Font.BOLD, 15));
		label_3.setBounds(156, 10, 72, 20);
		paneldescrip.add(label_3);
		
		JLabel label_4 = new JLabel("Description:");
		label_4.setForeground(new Color(153, 0, 0));
		label_4.setFont(new Font("Arabic Typesetting", Font.BOLD, 25));
		label_4.setBounds(10, 70, 118, 28);
		paneldescrip.add(label_4);
		
		JTextArea textArea = new JTextArea("_______"+BookName+BookName+"_______");
		textArea.setBounds(10, 119, 572, 50);
		paneldescrip.add(textArea);
		
		JSeparator separator = new JSeparator();
		separator.setBounds(10, 35, 100, 2);
		paneldescrip.add(separator);
		
		JSeparator separator_1 = new JSeparator();
		separator_1.setBounds(10, 69, 100, 2);
		paneldescrip.add(separator_1);
		
		JSeparator separator_2 = new JSeparator();
		separator_2.setBounds(10, 99, 100, 2);
		...
		separator_3.setBounds(10, 205, 916, 4);
		add(separator_3);
