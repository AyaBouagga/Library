...
public class BookSound extends JPanel{
	 ...
	 * @throws SQLException 
	 */
	public BookSound(int owner) throws SQLException {
		initialize();
		idOwner=owner;
	}
	...
	private void initialize() throws SQLException {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//filter the files
				FileNameExtensionFilter  sound = new FileNameExtensionFilter("mp3 & wav Images", "wav", "mp3");

				filepdf.addChoosableFileFilter(sound);
		...
		button.setBounds(145, 388, 105, 82);
		frame.getContentPane().add(button);

		JLabel lblImageDacceuilPour = new JLabel("<html>Select an existing file<html>");
		lblImageDacceuilPour.setForeground(Color.WHITE);
		lblImageDacceuilPour.setFont(new Font("Tahoma", Font.BOLD, 10));
		lblImageDacceuilPour.setBounds(145, 363, 120, 23);
		...
		button_1.setBounds(275, 388, 105, 82);
		...
		lblBookImage.setBounds(275, 341, 120, 20);
		...
		button_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AudioRecorder02 audio=new AudioRecorder02(compteur+1);
				path="junk"+(compteur+1)+".au";
			}
		});
		button_2.setIcon(new ImageIcon("C:\\Users\\eya\\Desktop\\java\\Biblio\\src\\Image\\microphone-black-shape.png"));
		button_2.setSelectedIcon(new ImageIcon("C:\\Users\\eya\\Desktop\\java\\Biblio\\src\\Image\\microphone-black-shape.png"));
		button_2.setSelected(true);
		button_2.setForeground(Color.WHITE);
		button_2.setFont(new Font("Arabic Typesetting", Font.BOLD, 25));
		button_2.setBorder(null);
		button_2.setBackground(Color.LIGHT_GRAY);
		button_2.setBounds(16, 388, 105, 82);
		frame.getContentPane().add(button_2);
		
		JLabel lblRecordNewBook = new JLabel("<html>Record new book</html>");
		lblRecordNewBook.setForeground(Color.WHITE);
		lblRecordNewBook.setFont(new Font("Tahoma", Font.BOLD, 10));
		lblRecordNewBook.setBounds(15, 358, 120, 32);
		frame.getContentPane().add(lblRecordNewBook);
		
		JLabel lblChooseFile = new JLabel("Choose file");
		lblChooseFile.setForeground(Color.WHITE);
		lblChooseFile.setFont(new Font("Tahoma", Font.BOLD, 17));
		lblChooseFile.setBounds(66, 341, 120, 20);
