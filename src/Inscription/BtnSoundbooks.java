...
public class BtnSoundbooks extends JPanel {
	 ...
	 */
	public BtnSoundbooks(int owner) {
		idOwner=owner;
		setBackground(Color.WHITE);
		setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "BooksSound", TitledBorder.LEFT, TitledBorder.TOP, null, new Color(153, 0, 0)));
		setLayout(null);
		...
		String req_select="Select * From book where type='sound' and idOwner='"+idOwner+"'";
