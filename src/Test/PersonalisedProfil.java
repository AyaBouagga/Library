...
import Inscription.BtnSoundbooks;
...
public class PersonalisedProfil extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PersonalisedProfil window = new PersonalisedProfil(2);
	...
	private void initialize() throws SQLException {
		...
		btnFriends.setBounds(477, 11, 115, 48);
		...
		separatorFriends.setBounds(477, 63, 122, 2);
		...
		separator_6.setBounds(598, 63, 611, 2);
		...
		JMenuItem mntmUse = new JMenuItem("Use");
		mntmUse.setForeground(Color.WHITE);
		mntmUse.setBackground(Color.BLACK);
		mnNewMenu_1.add(mntmUse);
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(result == JFileChooser.APPROVE_OPTION){
					...
					button.setIcon(ResizeImage("icon.rounded.jpg",button));
					try {
		...
		button.setBounds(26, 105, 128, 125);
		button.setIcon(new ImageIcon("C:\\Users\\eya\\Desktop\\java\\Biblio\\src\\Image\\add.png"));
		...
		button.setBounds(26, 105, 118, 125);
		panel_1.add(button);
